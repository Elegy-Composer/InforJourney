...
class Output:
    ...
    def stat_category(self, identifier):
        ...
        keyboard = InlineKeyboardMarkup(inline_keyboard=kb_list)
        self.bot.editMessageText(identifier, "請選擇種類", reply_markup=keyboard)
    ...
    def stat_monster_stage(self, identifier):
        ...
        keyboard = InlineKeyboardMarkup(inline_keyboard=kb_list)
        self.bot.editMessageText(identifier, "請選擇", reply_markup=keyboard)
    ...
    def send_blacksmith_service(self, upgrade, weapon_cost, armor_cost, message = None):
        ...
        return self.bot.editMessageText(message_identifier(message), f"{message['text']}\n{content}", reply_markup=self.end_markup)
